...
namespace FelixBang
{
    public class FBClickEventListener : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
    {
        public static FBClickEventListener Get(GameObject obj)
        {
            FBClickEventListener listener = obj.GetComponent<FBClickEventListener>();
            if (listener == null)
            {
                listener = obj.AddComponent<FBClickEventListener>();
            }
            return listener;
        }
