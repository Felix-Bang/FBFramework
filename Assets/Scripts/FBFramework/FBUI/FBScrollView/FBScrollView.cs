...
namespace FelixBang
{
    ...
    public class FBItemPool
    {
        ...
        List<FBScrollViewItem> mTmpPooledItemList = new List<FBScrollViewItem>();
        List<FBScrollViewItem> mPooledItemList = new List<FBScrollViewItem>();
        ...
        public void Init(GameObject prefabObj, float padding,float startPosOffset, int createCount, RectTransform parent)
        {
            ...
            {
                FBScrollViewItem tViewItem = CreateItem();
                RecycleItemReal(tViewItem);
            }
        }
        public FBScrollViewItem GetItem()
        {
            mCurItemIdCount++;
            FBScrollViewItem tItem = null;
        ...
        public FBScrollViewItem CreateItem()
        {
            ...
            FBScrollViewItem tViewItem = go.GetComponent<FBScrollViewItem>();
            tViewItem.ItemPrefabName = mPrefabName;
            tViewItem.StartPosOffset = mStartPosOffset;
            return tViewItem;
        }
        void RecycleItemReal(FBScrollViewItem item)
        {
            item.gameObject.SetActive(false);
            mPooledItemList.Add(item);
        }
        public void RecycleItem(FBScrollViewItem item)
        {
    ...
    public class FBScrollView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        Dictionary<string, FBItemPool> mItemPoolDict = new Dictionary<string, FBItemPool>();
        List<FBItemPool> mItemPoolList = new List<FBItemPool>();
        [SerializeField]
        ...
        List<FBScrollViewItem> mItemList = new List<FBScrollViewItem>();
        ...
        System.Func<FBScrollView, int, FBScrollViewItem> mOnGetItemByIndex;
        ...
        public System.Action<FBScrollView,FBScrollViewItem> mOnSnapItemFinished = null;
        public System.Action<FBScrollView, FBScrollViewItem> mOnSnapNearestChanged = null;
        ...
        FBClickEventListener mScrollBarClickEventListener = null;
        ...
        */
        public void InitListView(int itemTotalCount,
            System.Func<FBScrollView, int, FBScrollViewItem> onGetItemByIndex,
            LoopListViewInitParam initParam = null)
        {
            ...
            mCurSnapData.Clear();
            mItemPosMgr = new FBItemPosMgr(mItemDefaultWithPaddingSize);
        ...
        void SetScrollbarListener()
        {
            ...
            FBClickEventListener listener = FBClickEventListener.Get(curScrollBar.gameObject);
        ...
        */
        ...
        public FBScrollViewItem GetShownItemByItemIndex(int itemIndex)
        {
        ...
        */
        public FBScrollViewItem GetShownItemByIndex(int index)
        {
            int count = mItemList.Count;
        ...
        public FBScrollViewItem GetShownItemByIndexWithoutCheck(int index)
        {
            return mItemList[index];
        }

        public int GetIndexInShownItemList(FBScrollViewItem item)
        {
            if(item == null)
                return -1;
        ...
        public void DoActionForEachShownItem(Action<FBScrollViewItem,object> action,object param)
        {
            if(action == null)
                return;
        ...
        public FBScrollViewItem NewListViewItem(string itemPrefabName)
        {
            FBItemPool pool = null;
            ...
            FBScrollViewItem item = pool.GetItem();
        ...
        */
        ...
        {
            FBScrollViewItem item = GetShownItemByItemIndex(itemIndex);
            if (item == null)
            {
                return;
            }
        ...
        */
        public void RefreshItemByItemIndex(int itemIndex)
        {
            ...
            FBScrollViewItem curItem = mItemList[i];
            Vector3 pos = curItem.CachedRectTransform.localPosition;
            RecycleItemTmp(curItem);
            FBScrollViewItem newItem = GetNewItemByIndex(itemIndex);
            if (newItem == null)
            {
        ...
        */
        public void MovePanelToItemIndex(int itemIndex, float offset)
        {
            ...
            if (mSupportScrollBar)
            {
                float itemSize = mIsVertList ? newItem.CachedRectTransform.rect.height : newItem.CachedRectTransform.rect.width;
                SetItemSize(itemIndex, itemSize, newItem.Padding);
                //if (mIsVertList)        
        ...
        public void RefreshAllShownItemWithFirstIndex(int firstItemIndex)
        {
            ...
            FBScrollViewItem firstItem = mItemList[0];
            Vector3 pos = firstItem.CachedRectTransform.localPosition;
            RecycleAllItem();
            for (int i = 0; i < count; ++i)
            {
                int curIndex = firstItemIndex + i;
                FBScrollViewItem newItem = GetNewItemByIndex(curIndex);
                if (newItem == null)
                    break;
                ...
                {
                    float itemSize = mIsVertList ? newItem.CachedRectTransform.rect.height : newItem.CachedRectTransform.rect.width;
                    SetItemSize(curIndex, itemSize, newItem.Padding);
        ...
        {
            RecycleAllItem();
            FBScrollViewItem newItem = GetNewItemByIndex(firstItemIndex);
            if (newItem == null)
                return;
            ...
            {
                float itemSize = mIsVertList ? newItem.CachedRectTransform.rect.height : newItem.CachedRectTransform.rect.width;
                SetItemSize(firstItemIndex, itemSize, newItem.Padding);
        ...
        void RecycleItemTmp(FBScrollViewItem item)
        {
            if (item == null)
                return;
        ...
        void RecycleAllItem()
        {
            foreach (FBScrollViewItem item in mItemList)
            {
                RecycleItemTmp(item);
            }
            mItemList.Clear();
        ...
        void InitItemPool()
        {
            foreach (ItemPrefabConfData data in mItemPrefabDataList)
            {
                ...
                AdjustAnchor(rtf);
                AdjustPivot(rtf);
                FBScrollViewItem tItem = data.mItemPrefab.GetComponent<FBScrollViewItem>();
                if (tItem == null)
                {
                    data.mItemPrefab.AddComponent<FBScrollViewItem>();
                }
                FBItemPool pool = new FBItemPool();
                pool.Init(data.mItemPrefab, data.mPadding,data.mStartPosOffset, data.mInitCreateCount, mContainerTrans);
        ...
        FBScrollViewItem GetNewItemByIndex(int index)
        {
            ...
            FBScrollViewItem newItem = mOnGetItemByIndex(this, index);
            if (newItem == null)
            {
                return null;
            }
        ...
        public Vector3 GetItemCornerPosInViewPort(FBScrollViewItem item, ItemCornerEnum corner = ItemCornerEnum.LeftBottom)
        {
        ...
        void AdjustPanelPos()
        {
            ...
            if (mArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                FBScrollViewItem tViewItem0 = mItemList[0];
                ...
                FBScrollViewItem tViewItem1 = mItemList[mItemList.Count - 1];
        ...
        void UpdateSnapVertical(bool immediate = false)
        {
            ...
            if (immediate || Mathf.Abs(mCurSnapData.mTargetSnapVal - mCurSnapData.mCurSnapVal) < mSnapFinishThreshold)
            {
                ...
                {
                    FBScrollViewItem targetItem = GetShownItemByItemIndex(mCurSnapNearestItemIndex);
                    if(targetItem != null)
                    {
        ...
        void UpdateCurSnapData()
        {
            ...
            {
                FBScrollViewItem nearestItem = GetShownItemByItemIndex(mCurSnapNearestItemIndex);
                if (nearestItem == null)
                {
                    return;
                }
            ...
            {
                FBScrollViewItem targetItem = GetShownItemByItemIndex(mCurSnapData.mSnapTargetIndex);
                if (targetItem == null)
                {
                    mCurSnapData.Clear();
                    return;
        ...
        bool UpdateForVertList(float distanceForRecycle0,float distanceForRecycle1,float distanceForNew0, float distanceForNew1)
        {
            ...
            if (mArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                if (itemListCount == 0)
                {
                    ...
                    FBScrollViewItem newItem = GetNewItemByIndex(index);
                    if (newItem == null)
                    {
                        return false;
                    }
                ...
                if (mViewPortRectLocalCorners[0].y - downPos1.y < distanceForNew1)
                {
                    ...
                    {
                        FBScrollViewItem newItem = GetNewItemByIndex(nIndex);
                        if (newItem == null)
                        {
                            mCurReadyMaxItemIndex = tViewItem1.ItemIndex;
                            mNeedCheckNextMaxItem = false;
        ...
        void CheckIfNeedUpdataItemPos()
        {
            ...
            {
                FBScrollViewItem firstItem = mItemList[0];
                FBScrollViewItem lastItem = mItemList[mItemList.Count - 1];
        ...
        void UpdateAllShownItemsPos()
        {
            ...
            if (mArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                for (int i = 0; i < count; ++i)
                {
                    FBScrollViewItem item = mItemList[i];
