...
namespace FelixBang
{
    ...
    [CustomEditor(typeof(FBScrollView))]
    public class FBScrollViewEitor : Editor
    {
        ...
        void ShowItemPrefabDataList(FBScrollView listView)
        {
        ...
        public override void OnInspectorGUI()
        {
            ...
            FBScrollView tListView = serializedObject.targetObject as FBScrollView;
            if (tListView == null)
            {
                return;
            }
