...
namespace FelixBang
{
    ...
    public class ItemSizeGroup
    {
        ...
        int mDirtyBeginIndex = FBItemPosMgr.mItemMaxCountPerGroup;
        ...
        public void Init()
        {
            mItemSizeArray = new float[FBItemPosMgr.mItemMaxCountPerGroup];
            ...
            mItemStartPosArray = new float[FBItemPosMgr.mItemMaxCountPerGroup];
            mItemStartPosArray[0] = 0;
            mItemCount = FBItemPosMgr.mItemMaxCountPerGroup;
            ...
            {
                mDirtyBeginIndex = FBItemPosMgr.mItemMaxCountPerGroup;
            }
        }
    ...
    public class FBItemPosMgr
    {
        ...
        public FBItemPosMgr(float itemDefaultSize)
        {
            mItemDefaultSize = itemDefaultSize;
        }
